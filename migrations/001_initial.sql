...
-- an order can have any number of credit notes against it. Widening the index
-- to dodge that would leave every existing query on shp_invoices silently able
-- to pick up a credit note.
