...
.scd-row{display:block;padding:9px 14px;background:var(--color-bg-subtle);border-left:3px solid var(--color-primary);border-radius:0 7px 7px 0;font-size:14.5px;line-height:1.45;color:var(--color-text)}
