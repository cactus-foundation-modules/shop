...
// because the 'Admins only' visibility gate reads the admin session cookie via
...
// props across the boundary. When `visibility` is 'admin' the widget is withheld
