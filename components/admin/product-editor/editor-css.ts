...
.spe-card-title{margin:0 0 0.75rem;font-size:0.75rem;font-weight:600;letter-spacing:0.04em;text-transform:uppercase;color:var(--color-text-secondary)}
...
.spe-cover-empty{width:100%;aspect-ratio:1;border-radius:var(--radius-md);border:1px dashed var(--color-border);display:flex;align-items:center;justify-content:center;color:var(--color-text-secondary);font-size:0.8125rem;text-align:center;padding:0.5rem}
...
.spe-fact dt{color:var(--color-text-secondary);margin:0}
...
.spe-tab-badge{font-size:0.6875rem;font-weight:600;line-height:1;padding:0.125rem 0.3125rem;border-radius:var(--radius-full);background:var(--color-bg-subtle);border:1px solid var(--color-border);color:var(--color-text-secondary)}
...
.spe-section-blurb{margin:0 0 1rem;font-size:0.8125rem;color:var(--color-text-secondary);max-width:60ch}
...
.spe-optional{font-weight:400;color:var(--color-text-secondary)}
.spe-hint{font-size:0.75rem;color:var(--color-text-secondary);margin:0;max-width:60ch}
...
.spe-prefix{display:flex;align-items:center;padding:0 0.625rem;border:1px solid var(--color-border);border-right:none;border-radius:var(--radius-md) 0 0 var(--radius-md);background:var(--color-bg-subtle);color:var(--color-text-secondary);font-size:0.875rem;white-space:nowrap}
.spe-prefixed .spe-control{border-radius:0 var(--radius-md) var(--radius-md) 0}
.spe-suffix{display:flex;align-items:center;padding:0 0.625rem;border:1px solid var(--color-border);border-left:none;border-radius:0 var(--radius-md) var(--radius-md) 0;background:var(--color-bg-subtle);color:var(--color-text-secondary);font-size:0.875rem;white-space:nowrap}
...
.spe-count{font-size:0.6875rem;color:var(--color-text-secondary);text-align:right}
...
.spe-switch-hint{font-size:0.75rem;color:var(--color-text-secondary)}
...
.spe-check-empty{padding:0.75rem;font-size:0.8125rem;color:var(--color-text-secondary);margin:0}
...
.spe-media-tag{position:absolute;top:0.375rem;right:0.375rem;font-size:0.625rem;font-weight:600;padding:0.125rem 0.375rem;border-radius:var(--radius-full);background:var(--color-info-bg);color:var(--color-info);border:1px solid var(--color-info-border)}
.spe-media-note{display:block;padding:0.25rem 0.375rem;font-size:0.625rem;color:var(--color-text-secondary);background:var(--color-surface);border-top:1px solid var(--color-border);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.spe-media-handle{cursor:grab;color:var(--color-text-secondary);background:none;border:none;padding:0.125rem 0.25rem;font-size:0.875rem;line-height:1}
.spe-media-handle:active{cursor:grabbing}
.spe-icon-btn{background:none;border:none;cursor:pointer;color:var(--color-text-secondary);padding:0.125rem 0.25rem;border-radius:var(--radius-sm);font-size:0.875rem;line-height:1;display:inline-flex;align-items:center}
...
.spe-empty{border:1px dashed var(--color-border);border-radius:var(--radius-md);padding:2rem 1rem;text-align:center;color:var(--color-text-secondary);font-size:0.875rem}
...
.spe-margin-label{font-size:0.6875rem;text-transform:uppercase;letter-spacing:0.04em;color:var(--color-text-secondary)}
...
/* --- Designed description (full-screen pop-out page builder) ------------ */
