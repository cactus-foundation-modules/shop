...
.sps-count{margin:0.25rem 0 0;font-size:0.875rem;color:var(--color-text-secondary)}
...
.sps-table th{position:sticky;top:0;text-align:left;padding:0.625rem 0.75rem;background:var(--color-bg-subtle);font-size:0.75rem;font-weight:600;letter-spacing:0.02em;text-transform:uppercase;color:var(--color-text-secondary);border-bottom:1px solid var(--color-border);white-space:nowrap}
...
.sps-thumb-empty{width:40px;height:40px;border-radius:var(--radius-md);border:1px dashed var(--color-border);display:flex;align-items:center;justify-content:center;color:var(--color-text-secondary);font-size:1rem;background:var(--color-bg-subtle)}
...
.sps-slug{margin:0.125rem 0 0;font-size:0.75rem;color:var(--color-text-secondary);font-family:var(--font-mono,monospace)}
.sps-price-was{margin-left:0.375rem;color:var(--color-text-secondary);text-decoration:line-through;font-size:0.8125rem}
.sps-subs{color:var(--color-primary);text-decoration:none;font-weight:500}
.sps-subs:hover{text-decoration:underline}
.sps-muted{color:var(--color-text-secondary)}
...
/* --- Empty / loading ---------------------------------------------------- */
.sps-empty{border:1px dashed var(--color-border);border-radius:var(--radius-lg);padding:3rem 1.5rem;text-align:center;color:var(--color-text-secondary)}
.sps-empty h3{margin:0 0 0.375rem;font-size:1rem;color:var(--color-text)}
.sps-empty p{margin:0 0 1rem;font-size:0.875rem}
.sps-loading{padding:2.5rem;text-align:center;color:var(--color-text-secondary);font-size:0.875rem}

/* --- Pagination --------------------------------------------------------- */
.sps-pager{display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:0.75rem;margin-top:1rem}
.sps-pager-info{font-size:0.8125rem;color:var(--color-text-secondary)}
