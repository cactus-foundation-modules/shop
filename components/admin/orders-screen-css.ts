...
/* --- Shared shell ------------------------------------------------------- */
.sox-count{margin:0.25rem 0 0;font-size:0.875rem;color:var(--color-text-secondary)}
.sox-muted{color:var(--color-text-secondary)}
...
.sox-card-head h2,.sox-card-head h3{margin:0;font-size:0.8125rem;font-weight:600;letter-spacing:0.02em;text-transform:uppercase;color:var(--color-text-secondary)}
...
.sox-tile-label{font-size:0.75rem;font-weight:600;letter-spacing:0.02em;text-transform:uppercase;color:var(--color-text-secondary)}
.sox-tile-value{font-size:1.375rem;font-weight:600;color:var(--color-text);line-height:1.2}
.sox-tile-note{font-size:0.75rem;color:var(--color-text-secondary)}
...
.sox-table th{position:sticky;top:0;z-index:1;text-align:left;padding:0.625rem 0.75rem;background:var(--color-bg-subtle);font-size:0.75rem;font-weight:600;letter-spacing:0.02em;text-transform:uppercase;color:var(--color-text-secondary);border-bottom:1px solid var(--color-border);white-space:nowrap}
...
.sox-sub{margin:0.125rem 0 0;font-size:0.75rem;color:var(--color-text-secondary)}
...
.sox-menu-head{padding:0.375rem 0.625rem;font-size:0.6875rem;font-weight:600;letter-spacing:0.02em;text-transform:uppercase;color:var(--color-text-secondary)}

/* --- Empty / loading / errors ------------------------------------------- */
.sox-empty{border:1px dashed var(--color-border);border-radius:var(--radius-lg);padding:3rem 1.5rem;text-align:center;color:var(--color-text-secondary)}
.sox-empty h3{margin:0 0 0.375rem;font-size:1rem;color:var(--color-text)}
.sox-empty p{margin:0 0 1rem;font-size:0.875rem}
.sox-loading{padding:2.5rem;text-align:center;color:var(--color-text-secondary);font-size:0.875rem}
...
.sox-pager-info{font-size:0.8125rem;color:var(--color-text-secondary)}
.sox-pager-btns{display:flex;gap:0.375rem;align-items:center}

/* --- Single order: header ------------------------------------------------ */
.sox-back{display:inline-block;margin-bottom:0.5rem;font-size:0.8125rem;color:var(--color-text-secondary);text-decoration:none}
...
.sox-orderhead-meta{margin:0.375rem 0 0;font-size:0.8125rem;color:var(--color-text-secondary)}
...
.sox-items th{text-align:left;padding:0.625rem 1rem;font-size:0.75rem;font-weight:600;letter-spacing:0.02em;text-transform:uppercase;color:var(--color-text-secondary);border-bottom:1px solid var(--color-border);white-space:nowrap}
...
.sox-meta-list li{font-size:0.8125rem;color:var(--color-text-secondary)}
...
.sox-detail-row dt{font-size:0.75rem;font-weight:600;letter-spacing:0.02em;text-transform:uppercase;color:var(--color-text-secondary)}
...
.sox-event-when{margin:0.125rem 0 0;font-size:0.75rem;color:var(--color-text-secondary)}
...
.sox-list-sub{margin:0.125rem 0 0;font-size:0.8125rem;color:var(--color-text-secondary)}
